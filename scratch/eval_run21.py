...
if __name__ == '__main__':
    ...
    if os.path.exists('scratch/jump_run20.onnx'):
        evaluate_policy('Run 20 (Symmetric Tuck, Trade-off)', 'scratch/jump_run20.onnx', jump_dur=0.55)
    if os.path.exists('scratch/jump_run21.onnx'):
        evaluate_policy('Run 21 (Physics Aligned Bandwidth)', 'scratch/jump_run21.onnx', jump_dur=0.55)
